...
The most epic file icon theme for Visual Studio Code. This icon theme is extracted from the original [Material Theme for Vscode](https://material-theme.site/) and for an immersive experience we suggest to use both
